...
setup(
    name='topology_lib_iperf',
    version=find_version('lib/topology_lib_iperf/__init__.py'),
    package_dir={'': 'lib'},
    ...
    description=(
        'Linux iperf command Communication Library for the Network Topology '
        'Framework.'
    ),
    ...
    entry_points={
        'topology_library_10': [
            'iperf = topology_lib_iperf.library'
        ]
    }
)
